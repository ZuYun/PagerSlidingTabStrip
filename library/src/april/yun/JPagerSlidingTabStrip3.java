 ...
 */
public class JPagerSlidingTabStrip3 extends HorizontalScrollView implements ISlidingTabStrip {

    private static final String TAG = JPagerSlidingTabStrip3.class.getSimpleName();
    ...
    public JPagerSlidingTabStrip3(Context context) {
        this(context, null);
    }


    public JPagerSlidingTabStrip3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public JPagerSlidingTabStrip3(Context context, AttributeSet attrs, int defStyle) {
